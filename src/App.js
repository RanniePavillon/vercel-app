...
function App() {
    const dynamicImage = "https://pofsis-business.s3.amazonaws.com/biz/1675245859953.png";
    ...
    return (
        <div>
            <Helmet>
                <meta name="og:image" content={dynamicImage} />
            ...
            <h1>Rannie Testing revised application23</h1>
